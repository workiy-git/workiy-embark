        ...
        if($('#our-work').length)
        {
          $(window).scroll(function (event) {
            ...
            $('.work-scrolling').toggleClass('first',
              scroll >= $('.work-right .one').offset().top - 800
            );
            $('.work-scrolling').toggleClass('second',
              scroll >= $('.work-right .two').offset().top - 800
            );
            $('.work-scrolling').toggleClass('third',
              scroll >= $('.work-right .three').offset().top - 800
            );
$('.work-scrolling').toggleClass('fourth',
              scroll >= $('.work-right .four').offset().top - 800
            );
			$('.work-scrolling').toggleClass('fifth',
              scroll >= $('.work-right .five').offset().top - 800
            );
          });
          $(window).scroll();
        }
...
$(".team-profile-wrapper-about").slick(
      ...
      if ($(window).width() < 1024) {
        ...
        $('.platform-logo-wrapper').on('init', function(slick) {
            $('.platform-logo-wrapper').fadeIn(1000);
        })
        .slick({
            slidesToShow: 5,
            slidesToScroll: 1,
