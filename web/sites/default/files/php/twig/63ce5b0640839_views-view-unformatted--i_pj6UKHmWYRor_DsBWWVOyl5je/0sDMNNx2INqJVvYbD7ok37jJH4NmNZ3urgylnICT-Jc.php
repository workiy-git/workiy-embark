...
/* themes/custom/workiy/templates/views/views-view-unformatted--insights-listing--featuredinsights.html.twig */
class __TwigTemplate_98abb3d0f21dc495da7ed630c3f5311c extends \Twig\Template
{
    private $source;
    private $macros = [];
...
$context["loop"], "first", [], "any", false, false, true, 58) && ((twig_get_attribute($this->env, $this->source, $context["loop"], "index", [], "any", false, false, true, 58) % 2) != 0))) {
    ...
    {
        return "themes/custom/workiy/templates/views/views-view-unformatted--insights-listing--featuredinsights.html.twig";
    }
            ...
            <div class=\"wky-col-sm-12 wky-col-lg-6\">
                {% if loop.first %}
                    <div class=\"featured left\">
                        <div class=\"left-content\">
                            <h3 class=\"heading light\">{{ view.style_plugin.getField(key, 'title') }}</h3>
...
</section>", "themes/custom/workiy/templates/views/views-view-unformatted--insights-listing--featuredinsights.html.twig", "/var/www/html/web/themes/custom/workiy/templates/views/views-view-unformatted--insights-listing--featuredinsights.html.twig");
    }
