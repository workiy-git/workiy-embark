...
/* themes/custom/workiy/templates/views/views-view-unformatted--teams--teamslisting.html.twig */
class __TwigTemplate_302e5d77d8a981f2a51b33a85def45ae extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row") : (""))];
        ...
        foreach ($context['_seq'] as $context["key"] => $context["row"]) {
            ...
            echo "                <div class=\"wky-col-sm-12 wky-col-lg-4\">
                    <div class=\"platform-listing-img\">
                        ";
            // line 33
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["view"] ?? null), "style_plugin", [], "any", false, false, true, 33), "getField", [0 => $context["key"], 1 => "field_team_image"], "method", false, false, true, 33), 33, $this->source), "html", null, true);
            echo "
                    </div>
            ...
            echo "</p>
                            <div class=\"social-links\">
                                ";
            // line 41
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["view"] ?? null), "style_plugin", [], "any", false, false, true, 41), "getField", [0 => $context["key"], 1 => "field_social_media"], "method", false, false, true, 41), 41, $this->source), "html", null, true);
            echo "
                            </div>
                        </div>
                    </div>
    ...
    {
        return "themes/custom/workiy/templates/views/views-view-unformatted--teams--teamslisting.html.twig";
    }
    ...
    {
        return array (  89 => 47,  77 => 41,  72 => 39,  68 => 38,  63 => 36,  57 => 33,  53 => 31,  49 => 30,  42 => 25,  40 => 22,  39 => 21,);
    }
                ...
                <div class=\"wky-col-sm-12 wky-col-lg-4\">
                    ...
                    <div class=\"platform-listing-content\">
                        ...
                        <div class=\"right-content\">
                            ...
                            <div class=\"social-links\">
                                {{ view.style_plugin.getField(key, 'field_social_media') }}
                            </div>
                        </div>
                    </div>
                </div>
...
</section>", "themes/custom/workiy/templates/views/views-view-unformatted--teams--teamslisting.html.twig", "/var/www/html/web/themes/custom/workiy/templates/views/views-view-unformatted--teams--teamslisting.html.twig");
    }
