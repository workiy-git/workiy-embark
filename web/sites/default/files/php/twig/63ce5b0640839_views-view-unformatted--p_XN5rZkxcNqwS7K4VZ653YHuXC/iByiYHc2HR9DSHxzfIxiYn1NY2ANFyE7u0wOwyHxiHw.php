...
/* themes/custom/workiy/templates/views/views-view-unformatted--partners--partnerslisting.html.twig */
class __TwigTemplate_7610ae2ec07581d7eeb1360c8a5a10db extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["default_row_class"] ?? null)) ? ("views-row") : (""))];
    ...
    <div class=\"wky-container\">        
        ...
        foreach ($context['_seq'] as $context["key"] => $context["row"]) {
            // line 29
            echo "                <div class=\"wky-col-sm-12 wky-col-lg-4 partcol\">
                    <div class=\"partners-listing-item\">
                        <div class=\"insight-image\">
                            ";
            // line 32
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["view"] ?? null), "style_plugin", [], "any", false, false, true, 32), "getField", [0 => $context["key"], 1 => "field_partner_image1"], "method", false, false, true, 32), 32, $this->source), "html", null, true);
            echo "
                        </div>
            ...
            echo "</p>
                            <!--<a  href=\"";
            // line 37
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, twig_trim_filter(twig_striptags($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["view"] ?? null), "style_plugin", [], "any", false, false, true, 37), "getField", [0 => $context["key"], 1 => "view_node_1"], "method", false, false, true, 37), 37, $this->source))), "html", null, true);
            echo "\" class=\"client-link btn primary-btn\">Read more</a>-->
                        </div>
                    </div>                    
                </div>
            ";
    ...
    {
        return "themes/custom/workiy/templates/views/views-view-unformatted--partners--partnerslisting.html.twig";
    }
...
<section class=\"insights-listing\">
    <div class=\"wky-container\">        
        <div class=\"wky-row wky-wrap\">
            {% for key,row in rows %}
                <div class=\"wky-col-sm-12 wky-col-lg-4 partcol\">
                    <div class=\"partners-listing-item\">
                        <div class=\"insight-image\">
                            {{ view.style_plugin.getField(key, 'field_partner_image1') }}
                        </div>
                        <div class=\"insight-content\">
                            ...
                            <!--<a  href=\"{{ view.style_plugin.getField(key, 'view_node_1')|striptags|trim }}\" class=\"client-link btn primary-btn\">Read more</a>-->
                        </div>
                    </div>                    
                </div>
            {% endfor %}
...
</section>", "themes/custom/workiy/templates/views/views-view-unformatted--partners--partnerslisting.html.twig", "/var/www/html/web/themes/custom/workiy/templates/views/views-view-unformatted--partners--partnerslisting.html.twig");
    }
